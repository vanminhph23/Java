...
public class MarkerOptions extends JavascriptObject {
    ...
    private com.minhthuan.lib.maps.Marker.Level level;
    ...
    public MarkerOptions icon(Object o, com.minhthuan.lib.maps.Marker.Level level,int zoom) {
        setProperty("icon", Ultil.getImageLevelJam(o, level, zoom));
        this.level = level;
        return this;
    }
